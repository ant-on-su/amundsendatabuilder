...
if __name__ == "__main__":
    ...
    if create_connection(DB_FILE):
        # Tables and Columns:
        run_table_column_job(os.path.join(path, 'api_table.csv'), os.path.join(path, 'api_col.csv'))
        # Stats:
        run_csv_job(os.path.join(path, 'api_stats.csv'), 'test_table_column_stats',
        ...
        # Owner
        run_csv_job(os.path.join(path, 'api_owner.csv'), 'test_table_owner_metadata',
        ...
        # Updated
        run_csv_job(os.path.join(path, 'api_updated.csv'), 'test_table_last_updated_metadata',
